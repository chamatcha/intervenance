...
= Features =
* Protection against disabled javascript from browser.
...
== Changelog ==
= 1.3.0 =
* **Protect form against disabled javascript**: Added script to protect form against disabled javascript from browser.
